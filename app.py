...
app.config['MAIL_USERNAME'] = 'ngarg82871@gmail.com'
app.config['MAIL_PASSWORD'] = '' # On Allow less secure app in gmail manage settings
...
def result():
    if request.method == 'POST':
        ...
        msg = Message(subject, sender = 'ngarg82871@gmail.com' , recipients = [email])
        msg.body = message
        mail.send(msg)
